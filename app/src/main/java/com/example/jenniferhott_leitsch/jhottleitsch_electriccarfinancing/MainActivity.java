package com.example.jenniferhott_leitsch.jhottleitsch_electriccarfinancing;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final EditText years = (EditText) findViewById(R.id.textYears);
        final EditText loan = (EditText) findViewById(R.id.textLoan);
        final EditText interest = (EditText) findViewById(R.id.textInterest);
